...
public class TomorrowEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tomorrow_edit);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class1").set(setvalue1);
                ...
                firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class2").set(setvalue2);
                ...
                firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class3").set(setvalue3);
                ...
                firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class4").set(setvalue4);
                ...
                firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class5").set(setvalue5);
                ...
                firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class6").set(setvalue6);



                //setting edit date in firebase
                //Map<String,Object > setEditDate =new HashMap<>();
                //setEditDate.put("nextdate",nextday);
                firebaseFirestore.collection("class").document("edit").update("nextdate",nextday);
    ...
    private void staticClass() {
        ...
        firebaseFirestore.collection("class").document("static").collection(nextday).document("class1").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
        ...
        firebaseFirestore.collection("class").document("static").collection(nextday).document("class2").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
        ...
        firebaseFirestore.collection("class").document("static").collection(nextday).document("class3").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
        ...
        firebaseFirestore.collection("class").document("static").collection(nextday).document("class4").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
        ...
        firebaseFirestore.collection("class").document("static").collection(nextday).document("class5").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
        ...
        firebaseFirestore.collection("class").document("static").collection(nextday).document("class6").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
    ...
    private void dynamicClass() {
        ...
        firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class1").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
        ...
        firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class2").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
        ...
        firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class3").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
        ...
        firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class4").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
        ...
        firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class5").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
        ...
        firebaseFirestore.collection("class").document("dynamic").collection(nextday).document("class6").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(documentSnapshot!=null)
                {
