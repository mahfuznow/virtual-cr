...
public class signUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Firebase.setAndroidContext(just.cse.mahfuz.virtual.cr.signUp.this);
        ...
        catagory.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
        {
            @Override
        ...
        unit.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if ("--Unit--".equals(myunit)) {
                    ...
                    ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(just.cse.mahfuz.virtual.cr.signUp.this, R.array.unitA, android.R.layout.simple_spinner_item);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    department.setAdapter(adapter);

                } else if ("B".equals(myunit)) {
                    ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(just.cse.mahfuz.virtual.cr.signUp.this, R.array.unitB, android.R.layout.simple_spinner_item);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    department.setAdapter(adapter);

                } else if ("C".equals(myunit)) {
                    ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(just.cse.mahfuz.virtual.cr.signUp.this, R.array.unitC, android.R.layout.simple_spinner_item);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    department.setAdapter(adapter);

                } else if ("D".equals(myunit)) {
                    ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(just.cse.mahfuz.virtual.cr.signUp.this, R.array.unitD, android.R.layout.simple_spinner_item);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    department.setAdapter(adapter);

                } else if ("E".equals(myunit)) {
                    ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(just.cse.mahfuz.virtual.cr.signUp.this, R.array.unitE, android.R.layout.simple_spinner_item);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    department.setAdapter(adapter);

                } else if ("F".equals(myunit)) {
                    ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(just.cse.mahfuz.virtual.cr.signUp.this, R.array.unitF, android.R.layout.simple_spinner_item);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    department.setAdapter(adapter);
